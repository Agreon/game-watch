  ...
  async up(): Promise<void> {
    ...
    this.addSql(`
      create table "info_source" (
        ...
        "created_at" timestamptz(0) not null,
        "updated_at" timestamptz(0) not null,
        "type" text check ("type" in ('steam', 'nintendo', 'psStore')) not null,
        "remote_game_id" varchar(255) not null,
        "disabled" bool not null,
        "resolve_error" bool not null,
        "data" json null,
    ...
    this.addSql(`
      ...
      add constraint "info_source_game_id_foreign" foreign key ("game_id")
