...
export class GameReducedNotificationCreator implements NotificationCreator<NotificationType.GameReduced> {
    public forNotificationType: NotificationType.GameReduced;
    ...
    public async createNotification(
        ...
        if (resolvedGameData.priceInformation.final >= existingGameData.priceInformation.final) {
            logger.debug(
                { context: { existingFinalPrice: existingGameData.priceInformation.final, newFinalPrice: resolvedGameData.priceInformation.final } },
