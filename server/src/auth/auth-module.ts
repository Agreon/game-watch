    ...
    imports: [
        ...
        JwtModule.registerAsync({
            ...
            useFactory: (configService: ConfigService<Environment, true>) => ({
                publicKey: Buffer.from(configService.get<string>("JWT_PUBLIC_KEY"), "base64").toString(),
                privateKey: Buffer.from(configService.get<string>("JWT_PRIVATE_KEY"), "base64").toString(),
                signOptions: {
